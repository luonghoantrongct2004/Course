...
[Area("Admin")]
[Authorize]
public class InstructureController : Controller
{
    private readonly AppDbContext _context;
    private readonly UserManager<User> _userManager;
    private readonly RoleManager<IdentityRole> _roleManager;

    public InstructureController(AppDbContext context, UserManager<User> userManager, RoleManager<IdentityRole> roleManager)
    {
        _context = context;
    ...
    {
        // Get total count of students in the "Instructure" role
        var totalStudents = (await _userManager.GetUsersInRoleAsync("Instructure")).Count;

        // Get paginated students
        var students = (await _userManager.GetUsersInRoleAsync("Instructure"))
        ...
        // Add Courses and Exams to ViewData
        ViewData["Course"] = _context.Courses.ToList();
