	...
	if ($('#passwordInput').length > 0) {
		...
		function poorPasswordStrength(passwordLength, poorPassword, weakPassword, strongPassword) {
			if (passwordLength < 8) {
				...
				passwordInfo.innerHTML = '<img src="/assets/img/icon/angry.svg" style="width: 15px;" class="me-2"> ' + "Yếu. Phải chứa ít nhất 8 ký tự";
			}
		}
		...
		function weakPasswordStrength(passwordLength, poorPassword, weakPassword, strongPassword) {
			if (passwordLength >= 8 && (poorPassword || weakPassword || strongPassword)) {
				...
				passwordInfo.innerHTML = '<img src="/assets/img/icon/anguish.svg" style="width: 15px;" class="me-2">' + "Trung bình. Phải chứa ít nhất 1 ký tự hoặc số";
			} else {
		...
		function strongPasswordStrength(passwordLength, poorPassword, weakPassword, strongPassword) {
			if (passwordLength >= 8 && poorPassword && (weakPassword || strongPassword)) {
				...
				passwordStrength.classList.remove("heavy-active");
				passwordInfo.innerHTML = '<img src="/assets/img/icon/smile.svg" style="width: 15px;" class="me-2">' + "Gần đúng. Phải chứa ký tự đặc biệt";
		...
		function heavyPasswordStrength(passwordLength, poorPassword, weakPassword, strongPassword) {
			if (passwordLength >= 8 && (poorPassword && weakPassword) && strongPassword) {
				...
				passwordInfo.innerHTML = '<img src="/assets/img/icon/smile.svg" style="width: 15px;" class="me-2">' + "Tuyệt vời! Bạn có một mật khẩu an toàn.";
